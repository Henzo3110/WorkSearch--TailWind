...
function MainInicial() {
    ...
    return (
        <>
            ...
            <main className="flex w-full h-full mt-auto z-10" >
                <div className="w-1/2 mt-20 xl:mt-40" >
                    ...
                    <div className="flex items-center justify-center mt-3.5">
                        <button onClick={() => Navigate('/login')} className="flex bg-gradient-to-r from-cyan-400 via-cyan-300 to-cyan-100 rounded-full font-semibold text-3xl text-black pr-12 pl-12">Entrar</button>
                    </div>
                </div>
                <div>
            ...
            <footer className='hidden fixed bottom-0 lg:flex items-center justify-between w-full h-1/4 px-32 py-5 bg-gray-600 z-10'>
